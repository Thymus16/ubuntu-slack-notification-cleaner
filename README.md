...
Skip this section if you want to use the prebuilt package included in `dist/`.
...
The packaged extension is written to `dist/ubuntu-slack-notification-cleaner@thymus16.github.io.shell-extension.zip`.
...
```bash
gnome-extensions install --force dist/ubuntu-slack-notification-cleaner@thymus16.github.io.shell-extension.zip
